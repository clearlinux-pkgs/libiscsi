...
Version  : 1.20.0
Release  : 9
URL      : https://github.com/sahlberg/libiscsi/archive/1.20.0/libiscsi-1.20.0.tar.gz
Source0  : https://github.com/sahlberg/libiscsi/archive/1.20.0/libiscsi-1.20.0.tar.gz
...
%prep
%setup -q -n libiscsi-1.20.0
cd %{_builddir}/libiscsi-1.20.0
pushd ..
cp -a libiscsi-1.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720051615
...
cp %{_builddir}/libiscsi-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libiscsi/f12cd6fb8d937bce8255817b96793d0d1ea6f997 || :
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libiscsi.so.10.0.0
